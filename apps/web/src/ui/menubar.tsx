...
function MenubarTrigger({
  ...
  return (
    <DropdownMenuTrigger
      className={cn(
        "flex select-none items-center rounded-[calc(var(--radius-md)-(2px*var(--radius-scale)))] px-2 py-[calc(--spacing(0.85))] font-medium text-xs/relaxed outline-hidden hover:bg-muted aria-expanded:bg-muted",
        className
      )}
